...
<div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Nueva dependencia') }}</div>
    
                    <div class="card-body">
                        <form method="POST" action="{{ route('dependences.store') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="code" type="text" class="form-control @error('code') is-invalid @enderror" name="code" required autocomplete="code"> @error('code')
